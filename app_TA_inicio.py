...
preguntas = [
{
        "id": 0,
        "tipo": "opcion",
        "texto": f"{amigo1}, {amigo2}, {amigo3} y vos son un grupo de amigos. ¡El cumpleaños de {amigo3} es en 10 días! Estás pensando organizarle un cumpleaños a {amigo3}:\nPreferirías:",
    ...
    },
    {
        "id": 16,
        "tipo": "escala",
        "texto": "En caso que se rompa o daño algún aparato u objeto en el cumpleaños,\n¿qué tan dispuesto/preparado estás para arreglarlo?",
    },
    {
        "id": 17,
        "tipo": "escala",
...
# --- 3. LÓGICA DE DETECCIÓN DE FINALES (Basado en Pregunta 0 y 19) ---
def mostrar_final():
    st.title("🎂 El desenlace de la fiesta...")
    
    # Obtenemos las respuestas clave usando sus IDs numéricos enteros
