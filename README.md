...
El dataset que contiene a los 5mil paricipantes del test de hollan es un archivo de excel creado con IA y guardado en la carpeta "datos" dentro del repositorio.
...
Diagramas de flujo: en la carpeta "guia de trabajo" se encuentran todos los diagramas de flujo y ademnas un texto explicando el funcionamiento general (un poco mas aplio qu el de aca) del codigo.
