...
Diagramas de flujo: en la carpeta "guia de trabajo" se encuentran todos los diagramas de flujo y ademnas un texto explicando el funcionamiento general (un poco mas amplio que el de acá) del código.
